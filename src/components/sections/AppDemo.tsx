      ...
      <div className="max-w-[var(--spacing-container-max-width)] mx-auto px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)]">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-12 lg:gap-20 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-6 w-full max-w-xl">
            <h2 className="text-center font-headline-lg font-[var(--text-headline-lg--font-weight)] text-[40px] md:text-[52px] leading-tight tracking-[var(--text-headline-lg--letter-spacing)] text-text-main select-none">
