...
const roles = [
  ...
  { icon: Sprout, title: 'Aligned Sponsor', body: 'For brands with plant-based products or vegan-friendly services looking to advertise directly to high-intent conscious consumers around the world. As a Sponsor Doubler, your ad placement doubles the sanctuary contribution generated by a user\'s transaction.' },
