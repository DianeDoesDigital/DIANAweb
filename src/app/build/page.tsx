          ...
          <div className="max-w-[var(--spacing-container-max-width)] mx-auto px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)]">
            <div className="w-full text-center mb-12">
              <h2 className="font-headline-lg font-[var(--text-headline-lg--font-weight)] text-[28px] md:text-[56px] leading-tight mt-4 select-none">
                <span className="inline md:block text-secondary">The Desire Was Always There, </span>
                <span className="inline md:block text-primary">Now We Have the Infrastructure</span>
              </h2>
