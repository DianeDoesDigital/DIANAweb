...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full antialiased snap-y snap-mandatory">
      <head>
      ...
      <body className="min-h-full flex flex-col selection:bg-primary selection:text-white snap-y snap-mandatory">
        {children}
        <Footer />
        <GlobalAppDemo />
        <Analytics />
