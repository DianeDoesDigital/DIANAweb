  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. While DIANA itself is a technology routing platform and not a charity, your funds are routed directly to registered charities and non-profits. This means your sanctuary pledge functions as a direct charitable contribution to those organisations. At the end of each funding cycle, DIANA provides you with consolidated, automated receipts from those partner charities for your pledges, which you can use for tax deduction purposes according to your local tax laws."
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Core Team members take on a serious, high-ownership role shaping the long-term direction of the platform, compensated via sweat equity and deferred backpay upon raising capital. Community Contributors have flexible, task-based or async involvement contributing hours in code, design, writing, or advisory as their schedule permits, receiving portfolio credit and official recognition."
      },
      {
        q: "What does a Global Ambassador do?",
        a: "Global Ambassadors act as our grassroots champions. They carry DIANA into spaces digital marketing can't reach alone—tabling at vegan festivals, networking at community events, and personally introducing ethical merchants and local animal sanctuaries to the platform."
      },
      {
        q: "How do Financial Investors and Aligned Sponsors participate?",
        a: "Financial Investors (angels, pre-seed, or strategic funds) provide equity capital to scale our engineering and international routing infrastructure. Aligned Sponsors are brands with purely plant-based products or vegan-friendly services looking to advertise directly inside our ecosystem of conscious consumers. As a Sponsor Doubler, their ad placements double the sanctuary contribution generated by user transactions."
      },
      {
        q: "What does it mean to be an Ecosystem Partner?",
        a: "Not every ally is a merchant or sanctuary. Ecosystem Partners are advocacy collectives, media organizations, ethical coalitions, and university groups that formally partner with DIANA for co-campaigns, educational awareness, and cross-promotion."
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "DIANA is not a domestic Philippine charity soliciting public donations, which would require a DSWD Public Solicitation Permit. While the platform features an integrated digital wallet, DIANA itself does not hold consumer funds and does not require BSP EMI licensing. DIANA is an Australian technology company providing B2B payment routing software. All wallet balances and regulated payment processing are held and managed entirely by our licensed financial partners who maintain full compliance and hold the appropriate EMI licenses."
      },
      {
